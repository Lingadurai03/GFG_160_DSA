...
public class MinimumDaysToMakeMbouquets {
    public static void main(String[] args) {
        ...
        MinimumDaysToMakeMbouquets md = new MinimumDaysToMakeMbouquets();

        System.out.println(md.findMinDaysToMakeBouquet(arr, k, m));
    ...
    public int findMinDaysToMakeBouquet(int[] arr, int k, int m) {
        int low = 0;
